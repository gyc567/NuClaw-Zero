...
This summary anchors every subsequent decision. Include it in your session report (§7) and in your final verdict comment (§6.2). If you cannot articulate what the PR does and why, you are not ready to review it.

### 3.3 — Draft Status Check
...
## 4. Phase 2 — Analysis & Gate Checks

**Check draft status before starting this phase.**

### 4.1 — Malicious Content / Spam Detection
...
This is separate from test execution (§5.7). Tests catch *known* regressions; this step catches *untested* ones. Include findings in your review comments.

### 5.4 — Security & Performance Impact
...
Include this assessment in your final verdict comment (§6.2). This makes your reasoning visible to the maintainer and creates an audit trail.
...
- If the new commits materially change the PR's scope, restart from Phase 2 (§4).
- If they are minor fixups responding to your comments, review the delta and update your verdict accordingly.

### 6.2 — Verdict
Use one of three outcomes per `reviewer-playbook.md` §3.4. Every verdict comment must open with the **PR comprehension summary** from §3.2 (what, why, blast radius) and include the **security/performance assessment** from §5.4.
...
| Summary | What the PR changes, why, and blast radius (from §3.2) |
| Action | Skipped / Closed / Ready-to-merge / Needs-action / Needs-maintainer-review / Halted |
| Reason | Why this action was taken |
| Security/performance | Assessment from §5.4, or "N/A" for skipped/docs-only PRs |
